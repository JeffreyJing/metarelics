...
const TESTNET_CONTRACT_ADDRESS = '0xd081146088aB1d0a0dE64C0449eF5E02bFa0F5B5';

export const CONTRACT_ADDRESS = TESTING_MODE ? TESTNET_CONTRACT_ADDRESS : MAINNET_CONTRACT_ADDRESS;
export const WHITELIST_PRICE = TESTING_MODE ? 0.005 : 0.2;
export const WHITELIST_LIMIT = 1;
export const REGULAR_PRICE = TESTING_MODE ? 0.005 : 0.2;
